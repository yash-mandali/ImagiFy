...
const Footer = () => {
  return (
    <div className='flex flex-col md:flex-row items-center justify-between gap-6 py-6 md:py-8 mt-16 md:mt-20 border-t border-gray-400 px-4'>
      ...
      <p className='hidden md:flex flex-1 border-l border-gray-400 pl-4 text-sm md:text-sm text-gray-600 font-medium'>Copyright @Nexora AI | All right reserved.</p>
      <p className='md:hidden text-sm text-gray-600 text-center font-medium'>Copyright @Nexora AI | All right reserved.</p>
