    ...
    <motion.form
      ...
      <div>
        <div className='relative'>
          <img src={image} alt="" className='max-w-sm rounded mt-10' />
      ...
      {!isImageLoaded &&
        <div className='flex w-full max-w-xl bg-neutral-500 rounded-full text-white text-sm p-0.5 mt-10'>
          <input
          ...
          <button
            className='bg-zinc-900 px-10 py-3 sm:px-16 rounded-full text-white'
